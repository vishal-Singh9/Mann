...
const blueJobs = [
  {
    icon: Wrench,
    title: "Mechanics",
    description: "Skilled in repairing vehicles and machinery with precision.",
  },
  {
    icon: Truck,
    title: "Drivers",
    description: "Experienced in logistics, transport, and long-haul driving.",
  },
  {
    icon: Hammer,
    title: "Construction Workers",
    description: "Experts in building, renovation, and site maintenance.",
  },
];
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl px-6 md:px-16 lg:px-24">
            ...
            >
              <span className="text-blue-400">Blue Collar</span> Jobs
            </motion.h1>
            <motion.p
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
